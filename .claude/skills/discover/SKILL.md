...
**Output 1: Research Specification** → `journal/specs/research_spec_[topic].md`
```markdown
...
**Output 3: Decision Record** → `docs/decisions/discovery_[topic].md`
...
8. Save to `docs/literature/lit_review_[topic].md`
...
7. Save exploration to `docs/data_memos/data_exploration_[topic].md`
...
4. Save to `journal/specs/research_ideas_[topic].md`
