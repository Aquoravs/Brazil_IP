...
#### Save Reports
Save all outputs to `journal/reviews/`:
...
1. **Load prior review state** — read previous referee reports and editorial decision from `journal/reviews/`
...
6. **Save reports** with `_r2` or `_r3` suffix to `journal/reviews/`
...
Save report to `journal/audits/[file]_code_review.md`
...
Save report to `journal/audits/[file]_strategy_review.md`
...
- Save report to `journal/audits/[file]_proofread_report.md`
